...
public record Ex16_11_UserAccountDto(
...
/* 원래꺼에서 Long id 부분 뺀거*/
    public static Ex16_11_UserAccountDto of(String userId, String userPassword, String email, String nickname, String memo, LocalDateTime createdAt, String createdBy, LocalDateTime modifiedAt, String modifiedBy) {
        return new Ex16_11_UserAccountDto( userId, userPassword, email, nickname, memo, createdAt, createdBy, modifiedAt, modifiedBy);
    }
    ...
    public static Ex16_11_UserAccountDto of(String userId, String userPassword, String email, String nickname, String memo) {
        return new Ex16_11_UserAccountDto(userId, userPassword, email, nickname, memo, null, null, null, null);
    }

    /////////////////////////////////////////////////////////////////////////////

    public static Ex16_11_UserAccountDto from(UserAccount entity) {
        return new Ex16_11_UserAccountDto(
/*삭제*/         //entity.getId(),
                entity.getUserId(),
