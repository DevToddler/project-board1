...
public record Ex19_2_BoardPrincipal_인증(
    ...
    public static Ex19_2_BoardPrincipal_인증 of(String username, String password, String email, String nickname, String memo) {
        /* 권한정보를 컬렉션 데이터로 저장되기때문에 중복은 없다. 그래서 자료구조는 Set 이 되야한다.*/
        Set<RoleType> roleTypes = Set.of(RoleType.USER);

        return new Ex19_2_BoardPrincipal_인증(
                username,
                password,
    ...
    public static Ex19_2_BoardPrincipal_인증 from(UserAccountDto dto) {
        return Ex19_2_BoardPrincipal_인증.of(
                dto.userId(),
                dto.userPassword(),
                dto.email(),
                dto.nickname(),
