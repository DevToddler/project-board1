...
/** 할일: 아까 deleteArticle 처럼 updateArticle도 userId 를 넣어줘야한다. */
...
/* 유저정보 가져오기*/ UserAccount userAccount = userAccountRepository.getReferenceById(dto.userAccountDto().userId());
            System.out.println("dd: " + article.getUserAccount().equals(userAccount));
            System.out.println("dd: " + article.getUserAccount());
            System.out.println("dd: " + userAccount);
...
/*추가*/public void deleteArticle(long articleId, String userId) {
...
/*삭제*/ // articleRepository.deleteById(articleId);
/*추가*/ articleRepository.deleteByIdAndUserAccount_UserId(articleId, userId);
